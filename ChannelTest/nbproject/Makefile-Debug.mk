...
LDLIBSOPTIONS=-lzmq ../../../tools/ACE_wrappers/lib/libACE.so

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk /root/jiezisoft/bin/Debug/GNU-Linux-x86/channeltest

/root/jiezisoft/bin/Debug/GNU-Linux-x86/channeltest: ../../../tools/ACE_wrappers/lib/libACE.so

/root/jiezisoft/bin/Debug/GNU-Linux-x86/channeltest: ${OBJECTFILES}
	${MKDIR} -p /root/jiezisoft/bin/Debug/GNU-Linux-x86
	${LINK.cc} -o /root/jiezisoft/bin/Debug/GNU-Linux-x86/channeltest ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/DeviceStatus.o: DeviceStatus.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DeviceStatus.o DeviceStatus.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} /root/jiezisoft/bin/Debug/GNU-Linux-x86/channeltest
