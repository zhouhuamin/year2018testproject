...
{
    // "<VE_NAME>����D66681</VE_NAME>\n"
    // <PCAR_NO>����D66681</PCAR_NO>
    // test code
    while (!GlobalStopFlag)
    {
            ...
            if (ch == 's')
            {    
                // "<DR_IC_NO>73C474A5</DR_IC_NO>\n"
                for (int i = 0; i < 1; ++i)
                {
                    char szBuffer[6 + 1] = {0};
                std::string strSeqNo = "20160731191704";   
                sprintf(szBuffer, "%06d", i);
                strSeqNo += szBuffer;
                
                    g_nTestFlag	= 1;
std::string strXml = "<GATHER_INFO AREA_ID=\"7208070000\" CHNL_NO=\"7208070001\" I_E_TYPE=\"I\"";
         strXml += " SEQ_NO=\"";
         strXml += strSeqNo;
         strXml += "\"";
         strXml += "CHNL_TYPE=\"0\">\n"
...
"<IC_ESEAL_ID></IC_ESEAL_ID>\n"
"</RIC>\n"
"<OPTCAR><PCAR_NO></PCAR_NO><PCAR_NO_PICNAME></PCAR_NO_PICNAME><PCAR_PICNAME></PCAR_PICNAME></OPTCAR>\n"
"<VIDEO>\n"
"<CAMERA_IP>192.168.32.55</CAMERA_IP>\n"
"<VIDEO_ID>333333333</VIDEO_ID>\n"
"</VIDEO>\n"                 
"</GATHER_INFO>\n";
...
int main(int argc, char *argv[])
{
    ...
    int xxxx = sizeof(Bitmapset); // sizeof (T_Upload_Pic_Data);
